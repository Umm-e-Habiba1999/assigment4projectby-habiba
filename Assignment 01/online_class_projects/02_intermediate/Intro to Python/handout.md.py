...
def main():
    ...
    # Step 2: Ask the user to enter a planet name
    planet = input("Enter a planet: ")

    # Step 3: Check if the planet name is valid
    if planet in gravity_factors:
        # Step 4: Calculate the weight on the selected planet
